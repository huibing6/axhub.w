...
export default function Review() {
  ...
  const spActionColumn = (_: any, record: any) => (
    <Space size={4}>
      <Button type="link" size="small" style={{ color: '#ff4d4f' }} onClick={() => message.info('查看服务商')}>查看服务商</Button>
      <Button type="link" size="small" style={{ color: '#ff4d4f' }} onClick={() => message.info('复核')}>复核</Button>
    </Space>
  );
  ...
  return (
    <div>
      <Typography.Title level={4} style={{ margin: '0 0 16px' }}>复核</Typography.Title>
      <Tabs
        activeKey={activeTab}
