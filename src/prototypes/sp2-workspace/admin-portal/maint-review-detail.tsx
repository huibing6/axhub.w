...
import { BasicInfoCards, QualificationTable, RequiredDocsTable, MDGCards } from '../../admin-workspace/common/admission-shared';
import { QUALIFICATION_DOCS, RequiredDocItem } from '../../admin-workspace/common/admission-types';

const INITIAL_REQUIRED_DOCS: RequiredDocItem[] = [{ key: '1', name: '', upload: '' }];

export default function MaintReviewDetail() {
