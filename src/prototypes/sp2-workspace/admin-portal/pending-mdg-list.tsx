...
const rawData = [
  { idx: 1, spCode: '10000100', name: '中海油能源发展股份有限公司', code: '91440300MA5F1234AB', regDate: '2025-06-15', updateStatus: '待更新' },
  { idx: 2, spCode: '10000200', name: '杰瑞石油装备技术有限公司', code: '913706005971234523', regDate: '2025-07-20', updateStatus: '待更新' },
  { idx: 3, spCode: '10000300', name: '宝鸡石油钢管有限责任公司', code: '91610300220523456A', regDate: '2025-05-10', updateStatus: '已更新' },
  { idx: 4, spCode: '10000400', name: '山东科瑞机械制造有限公司', code: '91370500567890123B', regDate: '2025-08-01', updateStatus: '待更新' },
  { idx: 5, spCode: '10000500', name: '天津渤海石油装备制造有限公司', code: '91120116MA05CDEF5G', regDate: '2025-04-22', updateStatus: '已更新' },
  { idx: 6, spCode: '10000600', name: '四川宏华石油设备有限公司', code: '91510100MA6123456H', regDate: '2025-03-18', updateStatus: '待更新' },
  { idx: 7, spCode: '10000700', name: '河南中原测控技术有限公司', code: '91410100MA40JKLM7N', regDate: '2025-09-05', updateStatus: '已更新' },
  { idx: 8, spCode: '10000800', name: '北京石油机械有限公司', code: '91110108MA01PQRST8Q', regDate: '2025-02-28', updateStatus: '待更新' },
];
    ...
    },
    {
      ...
      render: (_: unknown, record: any) => (
        <Space size={4}>
          ...
          <Typography.Text type="secondary">|</Typography.Text>
          <Typography.Link style={{ fontSize: 13, color: '#ff4d4f' }} onClick={() => window.location.hash = `#/admin/pending-mdg-notify?code=${record.code}`}>发送通知</Typography.Link>
        </Space>
      ),
    },
  ];
