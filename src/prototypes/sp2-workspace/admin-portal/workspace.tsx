...
const statCards = [
  ...
  { title: '准入初审', count: 5, unit: '件待办', trend: 'flat', percent: 0, color: '#ff4d4f', icon: '🛡️' },
  ...
  const todoColumns = [
    ...
    { title: '提交时间', dataIndex: 'time', key: 'time', width: 120 },
    {
      ...
      render: (_: any, record: any) => (
        <Button type="link" size="small" style={{ color: '#ff4d4f' }} onClick={() => { window.location.hash = '#' + record.route; }}>
          审核
        </Button>
      ),
    },
