...
import { Typography, Input, Select, Button, Table, Card, Row, Col, Tabs, Form, Space } from 'antd';
...
export default function SpQueryQualified() {
  ...
  const filteredData = regData.filter(d => {
              ...
              children: (
                <Card variant="outlined" size="small">
                  <Form layout="vertical">
                    <Row gutter={24}>
                      <Col span={12}><Form.Item label="服务商名称"><Input value={basicInfoData.companyName} disabled /></Form.Item></Col>
                      <Col span={12}><Form.Item label="统一社会信用代码"><Input value={basicInfoData.creditCode} disabled /></Form.Item></Col>
                    </Row>
                    <Row gutter={24}>
                      <Col span={12}><Form.Item label="企业类型"><Input value={basicInfoData.companyType} disabled /></Form.Item></Col>
                    ...
                    <Row gutter={24}>
                      ...
                      <Col span={12}><Form.Item label="电子邮箱"><Input value={basicInfoData.contactEmail} disabled /></Form.Item></Col>
                    </Row>
                  </Form>
                </Card>
              ),
    ...
    <div>
      ...
      <Card size="small" variant="outlined" style={{ marginBottom: 16 }}>
        <Row gutter={24} style={{ marginBottom: 12 }}>
          ...
          <Col><Space size={8}><Typography.Text style={{ whiteSpace: 'nowrap' }}>流程状态</Typography.Text><Select style={{ width: 200 }} placeholder="全部" allowClear value={searchStatus} onChange={setSearchStatus} options={[{ value: '草稿', label: '草稿' }, { value: '审批中', label: '审批中' }, { value: '已通过', label: '已通过' }, { value: '已拒绝', label: '已拒绝' }]} /></Space></Col>
        </Row>
        <Row gutter={24}>
      ...
      <Table
        columns={[
          ...
          { key: 'action', title: '操作', width: 100, align: 'center' as const, render: () => <Typography.Link style={{ color: '#ff4d4f' }} onClick={() => setView('detail')}>查看</Typography.Link> },
        ]}
