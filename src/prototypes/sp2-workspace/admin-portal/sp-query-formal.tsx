...
const formalData = [
  { seq: 1, code: '1000020022', name: '中海油能源发展股份有限公司', mgmtType: '所属企业管理', useUnits: ['长庆油田', '大庆油田', '西南油气田'], status: '正常', creditCode: '91420000706802345X', regTime: '2025-12-19 09:15' },
  { seq: 2, code: '1000030033', name: '杰瑞石油装备技术有限公司', mgmtType: '总部管理', useUnits: ['长庆油田', '新疆油田'], status: '暂停', creditCode: '91420000706802345X', regTime: '2025-12-17 15:03' },
  { seq: 3, code: '1000040044', name: '宝鸡石油钢管有限责任公司', mgmtType: '所属企业管理', useUnits: ['大庆油田', '辽河油田', '吉林油田', '大港油田'], status: '正常', creditCode: '91420000706802345X', regTime: '2025-12-16 10:20' },
  { seq: 4, code: '1000050055', name: '山东科瑞机械制造有限公司', mgmtType: '总部管理', useUnits: [], status: '正常', creditCode: '91420000706802345X', regTime: '2025-12-14 11:08' },
  { seq: 5, code: '1000060066', name: '天津渤海石油装备制造有限公司', mgmtType: '所属企业管理', useUnits: ['长庆油田'], status: '正常', creditCode: '91420000706802345X', regTime: '2025-12-13 08:45' },
  { seq: 6, code: '1000070077', name: '四川宏华石油设备有限公司', mgmtType: '总部管理', useUnits: ['西南油气田', '塔里木油田'], status: '正常', creditCode: '91420000706802345X', regTime: '2025-12-12 14:20' },
];
