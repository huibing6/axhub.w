...
import { theme, Typography, Card, Space, Input, Button, Table, Tag, Modal } from 'antd';
...
const progressData = [
  { step: '第1步', unit: '服务商', unitColor: '#ff4d4f', status: '已提交', handler: '张明远', submitTime: '2025-12-19 09:15', finishTime: '2025-12-19 09:15', approved: '—', opinion: '—' },
  { step: '第2步', unit: '管理单位', unitColor: '#ff4d4f', status: '待复核', handler: '王建国', submitTime: '—', finishTime: '—', approved: '—', opinion: '—' },
];
    ...
    { key: 'dataSource', title: '数据来源', width: 110, dataIndex: 'dataSource', ellipsis: true },
    {
      ...
      render: () => (
        <Space size={2}>
          ...
          <Typography.Link style={{ fontSize: 13, color: '#ff4d4f' }} onClick={() => setProgressModalOpen(true)}>进度查询</Typography.Link>
        </Space>
      ),
    },
  ];
