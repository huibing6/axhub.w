...
import { theme, Typography, Card, Tabs, Checkbox, Button, message, Space, Modal } from 'antd';
  ...
  return (
    <PortalLayout groups={adminGroups} activePath="/admin/freeze-doc" portalType="admin">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        ...
        <Button type="primary" onClick={() => Modal.confirm({ title: '确认保存', content: '确定要保存当前配置吗？', okText: '确定', cancelText: '取消', onOk: () => message.success('冻结资质文件设定已保存') })}>保存配置</Button>
      </div>
