...
export default function AdmissionReviewPage() {
  ...
  const columns = [
    ...
    { key: 'workType', title: '工作单类型', width: 130, dataIndex: 'workType', ellipsis: true },
    {
      ...
      render: () => (
        <Space size={2}>
          <Typography.Link style={{ fontSize: 13, color: '#1677ff' }} onClick={() => window.location.hash = '#/admin/review-detail'}>查看</Typography.Link>
          <Typography.Text type="secondary">、</Typography.Text>
          <Typography.Link style={{ fontSize: 13, color: '#1677ff' }} onClick={() => window.location.hash = '#/admin/review-detail'}>复核</Typography.Link>
        </Space>
      ),
    },
  ];
