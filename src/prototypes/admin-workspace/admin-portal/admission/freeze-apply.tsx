...
export default function FreezeApplyPage() {
  ...
  const columns = [
    ...
    { key: 'action', title: '操作', width: 100, align: 'center' as const, render: (_: any, record: any) => <Button type="link" style={{ color: '#1677ff' }} onClick={() => handleFreezeApply(record)}>申请冻结</Button> },
  ];
