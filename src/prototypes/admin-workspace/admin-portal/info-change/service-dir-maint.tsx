...
import { theme, Typography, Card, Space, Input, Select, Button, Table, Tabs, Row, Col, message } from 'antd';
...
const columns = [
  ...
  { key: 'source', title: '数据来源', width: 140, dataIndex: 'source', ellipsis: true },
      ...
      <Tabs
        ...
        items={[
          ...
          },
          {
            key: 'pending',
            label: '已中标待准入服务品类',
            children: <div style={{ padding: 40, textAlign: 'center', color: t.colorTextQuaternary }}>已中标待准入服务品类（待开发）</div>,
          },
        ]}
      />
    </PortalLayout>
