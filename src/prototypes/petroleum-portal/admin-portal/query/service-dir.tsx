...
const rawData = [
  { seq: 1, code: 'GC', name: '工程技术服务', parent: '-', level: '1级', type: '通用', status: '启用', action: <Button type="link" size="small">查看</Button> },
  { seq: 2, code: 'GC-ZJ', name: '钻井工程', parent: '工程技术服务', level: '2级', type: '专业', status: '启用', action: <Button type="link" size="small">查看</Button> },
  { seq: 3, code: 'GC-CY', name: '采油工程', parent: '工程技术服务', level: '2级', type: '专业', status: '启用', action: <Button type="link" size="small">查看</Button> },
  { seq: 4, code: 'GC-SY', name: '试油技术服务', parent: '工程技术服务', level: '2级', type: '通用', status: '启用', action: <Button type="link" size="small">查看</Button> },
  { seq: 5, code: 'DM', name: '地面建设服务', parent: '-', level: '1级', type: '通用', status: '启用', action: <Button type="link" size="small">查看</Button> },
  { seq: 6, code: 'DM-GD', name: '管道工程', parent: '地面建设服务', level: '2级', type: '专业', status: '启用', action: <Button type="link" size="small">查看</Button> },
];
